...
static const GPathInfo QUINT4_PATH_INFO = {
  .num_points = 6,
  .points = (GPoint []) {{72, 84}, {72, 0}, {144, 0}, {144, 168}, {0, 168}, {0, 0}}
};
static const GPathInfo QUINT5_PATH_INFO = {
  .num_points = 7,
  .points = (GPoint []) {{72, 84}, {72, 0}, {144, 0}, {144, 168}, {0, 168}, {0, 0}, {70, 0}}
};
...
static void background_update_proc(Layer *layer, GContext *ctx) {
  ...
  GPoint minute_point = {
    .x = (int16_t)(sin_lookup(minute_angle) * (int32_t)200 / TRIG_MAX_RATIO) + 72,
    .y = (int16_t)(-cos_lookup(minute_angle) * (int32_t)200 / TRIG_MAX_RATIO) + 84,
  };
